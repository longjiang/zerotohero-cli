    ...
    <div class="row" v-if="$l1.code === 'en' && $l2.code === 'zh'">
      <div class="col-sm-12">
        ...
        <div>
          ...
          <div>
            <p>
              ...
              <a
                href="#/en/zh/textbooks-workbooks"
              >this page.</a>
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div>
            <p>
              We use <a href="https://teachable.com/">Teachable</a>.
            </p>
          </div>
        </div>
        <div>
    ...
    <div class="row" v-if="$l1.code === 'zh' && $l2.code === 'en'">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <p>
            访问“英语英雄”课件并观看视频请用微信或浏览器访问“英语英雄”在“短书”网站的店铺
            <a
              href="https://wazuc.duanshu.com/#/"
            >https://wazuc.duanshu.com/#/</a> 并用您的微信登陆。
          </p>
          <p>
            <br />
          </p>
          ...
          <p>“英语英雄”网站使用“短书”线上教育（即“知识付费”）平台将课程提供给您。您注册的账户也由 “短书” 直接管理。</p>
          <p>
            <br />
          </p>
          <h2>课本怎么买？</h2>
          ...
          <p>
            ...
            <a href="#/${$l1.code}/${$l2.code}/textbooks-workbooks">如何购买课本？</a>
          </p>
          <h2>
            <br />
          </h2>
          ...
          <p>
            ...
            <a
              :href="`#/${$l1.code}/${$l2.code}/course-release-schedule`"
            >课程发布时间表</a>。
          </p>
        </div>
        <div class="col-md-2"></div>
