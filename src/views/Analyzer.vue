    ...
    <div class="container mb-5">
      <div class="row">
        <div class="col-sm-12">
          ...
          ></textarea>
          <button v-on:click="analyze" class="btn btn-success btn-block">Analyze</button>
      ...
      <div class="row mt-5">
        <div class="col-sm-12">
          ...
          <ul>
            ...
            <li>
              Use the
              <a href="https://readlang.com/">ReadLang tool</a> to look
              up text quickly.
            </li>
            <li>
              Use
              <router-link to="/cases/nouns">this tool</router-link> to learn noun endings
              in context.
            </li>
          </ul>
        </div>
