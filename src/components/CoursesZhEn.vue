  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 text-center">
        <h2 class="mt-5 mb-5" style="font-weight: 100; font-size: 30px"><strong style="font-weight: 700">全面、系统、个性化</strong>的线上英语课程</h2>
        <img src="/img/divider-down.jpg" class="img-fluid" />
        <h4 class="mt-5 mb-5"><img src="/img/line-dot-right.png" style="width: 80px" class="mr-3">免费公开课<img src="/img/line-dot-left.png" style="width: 80px" class="ml-3"></h4>
      </div>
      ...
      <div class="col-sm-12 text-center">
        <h4 class="mt-5 mb-5"><img src="/img/line-dot-right.png" style="width: 80px" class="mr-3">付费课<img src="/img/line-dot-left.png" style="width: 80px"  class="ml-3"></h4>
      </div>
      <div class="row" style="max-width: 840px; margin: 0 auto">
        <div class="col-sm-6 col-md-4 text-center">
      ...
      <div class="col-sm-12 text-center mt-5">
        <img src="/img/divider-up.jpg" class="img-fluid mb-5" />
        <h2 class="mb-5" style="font-weight: 100; font-size: 30px">所有课程一律<strong style="font-weight: 700">永久有效</strong></h2>
        <a href="https://m.cctalk.com/inst/stevmab3" class="btn-cctalk">前往网校查看所有课程</a><br/>
        <img src="/img/logo-cctalk-gray.png" alt="" style="width: 115px; margin-top: 1rem;"><br/>
        <img src="/img/divider-down.jpg" class="img-fluid mt-5 mb-5" />
        <h2 style="font-weight: 100; font-size: 30px">我们在各大平台的<strong style="font-weight: 700">精彩英语学习内容</strong></h2>
      </div>
...
.btn-cctalk {
  ...
  box-shadow: 5px 5px 18px #2CBBFF;
  color: white;
  padding: 1rem 2.5rem;
