                ...
                <div class="row">
                  <div class="col-sm-6 col-md-4 mb-3">
                    ...
                    >
                      <img
                        :src="
                          `https://www.chinesezerotohero.com/wp-content/uploads/2021/01/Course-Covers.028.jpg`
                        "
                        alt="Ultimate Bundle"
                  ...
                  <div class="col-sm-6 col-md-4 mb-3">
                    ...
                    >
                      <img
                        :src="
                          `https://www.chinesezerotohero.com/wp-content/uploads/2021/01/Course-Covers.027.jpg`
                        "
                        alt="HSK 5 - 6 Bundle"
                        class="img-fluid shadow rounded"
                      />
                ...
                <div class="row">
                  ...
                  >
                    <a
                      target="_blank"
                      :href="
                        `https://chinesezerotohero.teachable.com/p/hsk-${hsk}-course/`
                      "
                    >
                      <img
                  ...
                  >
                    <a
                      target="_blank"
                      :href="
                        `https://chinesezerotohero.teachable.com/p/hsk-7-9-words`
                      "
                    >
                      <img
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-4 mb-3">
                    <a
                      target="_blank"
                      :href="
                        `https://chinesezerotohero.teachable.com/p/learn-chinese-with-songs`
                      "
                    >
                      <img
                        :src="
                          `https://process.fs.teachablecdn.com/ADNupMnWyR7kCWRvm76Laz/resize=width:705/https://www.filepicker.io/api/file/8h047RSQS2KbHEV58Tk6`
                        "
                  ...
                  <div class="col-sm-6 col-md-4 mb-3">
                    <a
                      target="_blank"
                      :href="
                        `https://chinesezerotohero.teachable.com/p/chinese-short-poems`
                      "
                    >
                      <img
                        :src="
                          `https://process.fs.teachablecdn.com/ADNupMnWyR7kCWRvm76Laz/resize=width:705/https://www.filepicker.io/api/file/CCmgMURQNW4CYXRxjbfL`
                        "
      ...
      <div class="row">
        <div class="col-sm-6">
          ...
          <p>
            ...
            unnecessary jargons and lengthy explanations and focus on practical
            applications.
          </p>
          <h5>Engaging</h5>
          <p>
        ...
        <div class="col-sm-6">
          ...
          <p>
            A question commonly posed is, why do you have one of the
            best-selling HSK courses on the web? The answers lie in the
            instructional philosophy behind our courses. This page outlines some
            of the important differences between our courses and other learning
            products commonly found on the web.
          </p>
          <p>
          ...
          <p>
            ...
            a learners need much more than a set of courses. They must be
          ...
          <p>
            <span>
              ...
              some extent because the nuances of Chinese grammar simply cannot
              be taught with explicit instruction alone. Nevertheless, input is
              only meaningful if they are understood. If learners are never
              taught grammar, how can they possibly understand sentences
              correctly? It is obvious, therefore, that some grammar must be
          ...
          <p>
            ...
            distinguishes us from most learning products out there. We hope
