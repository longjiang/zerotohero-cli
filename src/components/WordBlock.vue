...
export default {
  ...
  methods: {
    ...
    segment(text) {
      return text.replace(/([́ёеуюйыаоэяицкнгшщзхъфвпрлджчсмтьб])([цкнгшщзхъфвпрлджчсмтб])/gi, '$1·$2').replace(/·([цкнгшщзхъфвпрлджчсмтб])([цкнгшщзхъфвпрлджчсмтб])/gi, '$1·$2').replace(/·([цкнгшщзхъфвпрлджчсмтб])ь/gi, '$1ь').replace(/^(.)·/, '$1').replace(/·(.)$/, '$1')
      //([ёеуюйыаоэяи])
    },
    update() {
