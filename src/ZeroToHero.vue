        ...
        <div class="container-fluid p-2 pl-3 site-top-bar">
          <div>
            <a href="/" style="color: #ccc; line-height: 2.3rem;"
              ><i class="fa fa-chevron-left mr-2"></i>Zero to Hero Education</a
            >
          </div>
          <a
          ...
          <div class="row mt-5 mb-4 text-dark">
            <div class="col-sm-12 text-center">
              <p style="font-size: 1.5rem">
                Resources for learning <strong><em>hundreds</em></strong> of
                languages
              </p>
